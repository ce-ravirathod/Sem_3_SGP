...
<!-- <div class="menu_item">	 -->
	<div class="table">
		<a href="table_order.php?tid=<?php echo $tblno;?>">
			<div class="tb_no">
        		<h2><?php echo $tbl; $tbl=$tbl+1; ?></h2>
    		</div>
			<?php
				// include "dbcon.php";
				$qur="Select * from cart where table_id='$tblno'";
				...
				if($num > 0)
				{
					// echo "hi";
			?>
					<div class="state" style="background-color:red;">
						<h1> </h1>
    				</div>
			<?php
				}else 
				{
					// echo "not"
					?>
					<div class="state" style="background-color:green;">
						<h1> </h1>
    				</div>
					<?php
				}
